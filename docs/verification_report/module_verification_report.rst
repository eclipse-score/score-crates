...
.. document:: score-crates Verification Report
   :id: doc__score_crates_verification_report
   :status: draft
   :safety: ASIL_B
   :security: YES
...
**1.1. on Requirements**
       `Traceability and test result report <https://github.com/user-attachments/files/28588652/pastey_index_report.html>`_
...
**4.1. Structural Coverage**
       `coverage report <https://github.com/eclipse-score/score-crates/pull/31#issue-4254036938>`_
